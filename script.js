window.addEventListener("DOMContentLoaded", function () {
	...
	referralInput.addEventListener("blur", () => {
		if (referralInput.value.length >= 1) {
			referralImg.style.backgroundImage =
				"url(https://sunbirdapp.com/icons/name-on.svg)";
	...
	nameField.innerHTML +=
		'<div class="error-message"><img src="https://sunbirdapp.com/icons/disclaimer.svg" alt="error message" />Wrong name format</div>';
	emailSpan.children[0].remove();
	emailSpan.innerHTML +=
		'<div class="error-message"><img src="https://sunbirdapp.com/icons/disclaimer.svg" alt="error message" />Wrong email format</div>';
	checkbox.innerHTML +=
		'<div class="error-message"><img src="https://sunbirdapp.com/icons/disclaimer.svg" alt="error message" />Required</div>';
});
