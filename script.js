...
countryField.innerHTML = "<div class="country__img"></div><span>Country</span><span class="placeholder">Please select...</span><div class="country-list"><div class="country-list__search"><img src="icons/search.svg" alt="Search" /><input type="text" placeholder="Primamy Label" /></div><ul>
<li class="country-list-card">
	<img
		src="icons/flags/afganistan.svg"
		alt="afganistan"
...
<li class="country-list-card">
	<img src="icons/flags/albania.svg" alt="albania" /><span
		>Albania</span
	>
	<img
		class="checkmark"
...
<li class="country-list-card">
	<img src="icons/flags/algeria.svg" alt="algeria" /><span
		>Algeria</span
	>
	<img
		class="checkmark"
...
<li class="country-list-card">
	<img src="icons/flags/andorra.svg" alt="andorra" /><span
		>Andorra</span
	>
	<img
		class="checkmark"
...
<li class="country-list-card">
	<img src="icons/flags/angola.svg" alt="angola" /><span
		>Angola</span
	>
	<img
		class="checkmark"
...
<li class="country-list-card">
	<img src="icons/flags/tunisia.svg" alt="tunisia" /><span
		>Tunisia</span
	>
	<img
		class="checkmark"
...
<li class="country-list-card">
	<img
		src="icons/flags/united-arab-emirates.svg"
...
<li class="country-list-card">
	<img
		src="icons/flags/united-states.svg"
		alt="united states"
...
<img class="chevron" src="icons/chevron.svg" alt="arrow-down" />";
